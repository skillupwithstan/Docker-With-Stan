...
```
git clone https://github.com/skillupwithstan/Docker-With-Stan/
cd  examples
```
...
```
docker build -t skillupwithstan/my-first-docker-image:latest .
```
...
skillupwithstan/my-first-docker-image   latest    960d37536dcd   26 seconds ago   467MB
...
```
docker run -it skillupwithstan/my-first-docker-image
```
...
```
docker push skillupwithstan/my-first-docker-image
```
...
The push refers to repository [docker.io/skillupwithstan/my-first-docker-image]
896818320e80: Pushed
b8088c305a52: Pushed
69dd4ccec1a0: Pushed
